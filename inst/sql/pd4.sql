...
JOIN #yearInterval y
  ON DATEFROMPARTS(y.calendar_year, 1, 1) >= OBSPOP.observation_period_start_date
  AND DATEADD(day, @required_years, OBSPOP.observation_period_start_date) <= OBSPOP.observation_period_end_date
