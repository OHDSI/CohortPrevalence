...
We can select between yearly prevalence analyses or span prevalence analyses using `createYearlyPrevalence` and `createSpanPrevalence`.
...
periodOfInterestSpan <- createSpanPrevalence(startDates = c(2016, 2018, 2020),
